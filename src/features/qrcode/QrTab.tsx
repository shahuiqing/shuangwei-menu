    ...
    <div className="space-y-6">
      ...
      <div className="p-4 bg-zinc-950 rounded-2xl border border-zinc-800/50">
        <h3 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
          <QrCode size={20} className="text-orange-500" /> 管理桌台二维码
      ...
      <div className="p-4 bg-zinc-950 rounded-2xl border border-zinc-800/50">
        <h3 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
          <List size={20} className="text-orange-500" /> 所有桌台 (All Tables)
        </h3>
        {tables.length === 0 ? (
              ...
              >
                <div className="w-full flex justify-between items-start mb-4">
                  <div>
                    ...
                    >
                      {table.active ? "已开台 (Opened)" : "未开台 (Closed)"}
                    </div>
                  </div>
