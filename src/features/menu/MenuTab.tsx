...
import {
  Settings, Plus, DownloadCloud, UploadCloud, FileSpreadsheet, ArrowUp, ArrowDown,
  Trash2, Edit2, Image as ImageIcon, Languages, MoveUp, MoveDown, Sparkles, Copy,
  X, Save, Palette, Check, Loader2, HardDrive, RefreshCw, ArrowUpDown, Database,
} from "lucide-react";
...
export const PRESET_BACKGROUNDS = [
  { name: "默认主题", en: "Default", bg: "bg-gradient-to-br from-orange-600 via-orange-700 to-amber-900" },
  { name: "海洋蓝", en: "Ocean Blue", bg: "bg-gradient-to-br from-blue-600 via-cyan-600 to-teal-800" },
  { name: "森林绿", en: "Forest Green", bg: "bg-gradient-to-br from-green-600 via-emerald-600 to-teal-800" },
  { name: "神秘紫", en: "Mystic Purple", bg: "bg-gradient-to-br from-purple-600 via-violet-600 to-indigo-800" },
  { name: "玫瑰红", en: "Rose Red", bg: "bg-gradient-to-br from-rose-600 via-pink-600 to-red-800" },
  { name: "暗夜黑", en: "Night Black", bg: "bg-gradient-to-br from-zinc-800 via-zinc-900 to-black" },
  { name: "夕阳橙", en: "Sunset Orange", bg: "bg-gradient-to-br from-orange-500 via-red-500 to-rose-700" },
];
...
interface MenuTabProps {
  ...
  handleMoveDish: (catId: string, itemIdx: number, direction: 'up' | 'down' | 'top' | 'bottom') => void;
...
export function MenuTab(props: MenuTabProps) {
  const {
    categories, setCategories, newCategory, setNewCategory, newDish, setNewDish,
    handleAddCategory, handleAddDish, handleDeleteCategory, handleDeleteDish,
    handleMoveCategory, handleMoveDish, handleExportJson, handleExportCsv,
    handleAITranslate, handleAIEnhanceImage, handleApiKeyChange,
    setCurrency, setIsUploading, setUploadingItemId,
    setPromptDialog, setPromptValue, setSelectedCategory, setSortingCategoryId,
    currency, restaurantName, welcomeMessage, bgUrl, logoUrl, layoutStyle, theme, soundEnabled,
    receiptSettings, promotions, setPromotions, deletedItemIds, setDeletedItemIds,
    setRestaurantName, setWelcomeMessage, setBgUrl, setLogoUrl, setLayoutStyle, setTheme, setSoundEnabled,
    isUploading, promptValue, promptDialog, uploadingItemId, selectedCategory, sortingCategoryId,
    isOptimizing, optimizationProgress, onSaveToCloud, isTranslating, isEnhancing,
  } = props;
  return (
    <>
                <>
                                    ...
                                    <div className="flex items-center gap-2 overflow-hidden">
                                      <div className="flex flex-col gap-0.5 flex-shrink-0">
                                        <button
                                          type="button"
                                          disabled={itemIdx === 0}
                                          onClick={() => handleMoveDish(cat.id, itemIdx, "up")}
                                        ...
                                        <button
                                          ...
                                          onClick={() => handleMoveDish(cat.id, itemIdx, "down")}
                                          className="p-1 text-zinc-400 hover:text-amber-400 disabled:opacity-20 hover:bg-zinc-800 rounded transition-colors"
                                          title="菜品下移"
                                        >
                                          <ArrowDown size={12} />
