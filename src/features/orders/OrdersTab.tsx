                      ...
                      <div className="flex flex-wrap items-center justify-end gap-2 mt-1">
                        {order?.status !== "completed" && (
                          <>
                            ...
                            <button
                              onClick={async () => {
                                let currentTable = order?.customerName || "";
                                if (currentTable.startsWith("桌号_")) {
                                ...
                                if (
                                  ...
                                  try {
                                    ...
                                    alert("修改失败 (Failed to update table)");
                                  }
                                }
                              }}
                            ...
                            >
                              <CheckCircle size={14} /> 结账 (Complete)
                            </button>
                          </>
                        )}
                        <button
                        ...
                        <button
                          onClick={() => {
                            onConfirmDialog({
                              isOpen: true,
                              message:
                                "确定要删除此订单吗？ (Are you sure you want to delete this order?)",
                              onConfirm: async () => {
                                try {
