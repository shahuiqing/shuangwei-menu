...
ALTER TABLE public.settings DROP COLUMN IF EXISTS "adminPassword";
ALTER TABLE public.settings DROP COLUMN IF EXISTS "devicePasswords";
ALTER TABLE public.settings DROP COLUMN IF EXISTS "securityAnswer";
